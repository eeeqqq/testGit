  ...
  <div id="Head1">
    <div id="Logo">
      <a id="msgLink" href="javascript:void(0)"></a> <font
        color="#0000CC"
        style="color: #F1F9FE; font-size: 28px; font-family: Arial Black, Arial">天津大学仁爱学院学生请假系统</font>
  ...
  <div id="Head2">
    <div id="Head2_Awoke">
      <ul id="AwokeNum">
        ...
        <!-- 是否有待审批文档的提示1，数量 -->
        <li><a
          href="${pageContext.request.contextPath}/workFlow/mySubmittedList"
          target="right"> <img border="0" width="12" height="14"
            src="css/images/top/wait.gif" /> 审批结果（<span id="wait"
            class="taskListSize">1</span>）
        </a></li>

        <!-- 是否有待审批文档的提示2，提示审批 -->
        <li id="messageArea">点击查看审批结果！★★★★★</li>
      </ul>
    </div>
