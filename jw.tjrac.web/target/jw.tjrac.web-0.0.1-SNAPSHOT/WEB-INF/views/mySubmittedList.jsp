    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
      ...
      <tbody id="TableData" class="dataContainer" datakey="formList">
        ...
        <tr class="TableDetail1 template">
          <td><a href="${pageContext.request.contextPath}/Flow_Formflow/showForm.html">${approvalForm.approvalFormTitle}</a></td>
          <td>${approvalForm.applicant}&nbsp;</td>
          <td>${approvalForm.approvalTime}&nbsp;</td>
          <td>${approvalForm.applyDays }&nbsp;</td>
          <td>${approvalForm.approvalState}&nbsp;</td>
          <td><a href="${pageContext.request.contextPath}/Flow_Formflow/showForm.html">查看申请信息</a> <a
            href="${pageContext.request.contextPath}/Flow_Formflow/approvedHistory.html">查看流转记录</a></td>
        </tr>
        </c:forEach>
      </tbody>
    </table>
